// Example: To change the Home Page portrait
brideFullPortrait: "/studio-images/your-new-image.jpg", import { useState, useEffect, useRef } from "react";
...
import heroImg from "@/assets/wedding-bride-veil.png";
import expImg from "@/assets/wedding-bride-red.png";
import couple2 from "@/assets/wedding-couple-floral.jpg";
import mehndi from "@/assets/wedding-mehndi-2.webp";
      ...
      <section className="bg-blush min-h-[calc(100vh-105px)] grid grid-cols-1 lg:grid-cols-2 overflow-hidden border-b border-rose/10 relative">
        ...
        <div className="relative lg:h-auto w-full flex flex-col pt-0 order-2 lg:order-1 px-4 lg:px-6 lg:py-6 gap-3 lg:gap-4">
          ...
          <div className="grid grid-cols-2 relative z-10 gap-3 lg:gap-4">
            ...
            >
               <SafeImage src={couplePose} className="w-full h-full object-cover object-center" />
            </motion.div>
            <motion.div 
              style={{ y: y1 }}
              className="relative overflow-hidden shadow-xl aspect-[4/5] bg-charcoal/5"
            >
               <SafeImage src={brideOne} className="w-full h-full object-cover object-center" />
            </motion.div>
          </div>
        </div>
          ...
          <RollReveal className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
            ...
            >
              <div className="row-span-2 relative overflow-hidden group">
                <SafeImage src={brideOrig} className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110" />
              </div>
              <div className="relative overflow-hidden group">
                <SafeImage src={couplePose} className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110" />
              </div>
              <div className="relative overflow-hidden group bg-charcoal/5">
                <SafeImage src={brideOne} className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110" />
              </div>
            </motion.div>
          </RollReveal>
        </div>
        ...
        <div className="max-w-site mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            <div className="lg:col-span-5 relative">
              ...
              >
                <SafeImage src={couplePose} className="w-full h-full object-cover" />
              </motion.div>
